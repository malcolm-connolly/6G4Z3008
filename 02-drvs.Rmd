...
```{r uniformdice, fig.align="center", fig.cap="Probability mass function for a fair die", echo=FALSE}
...
```{r geomdriving, fig.align="center", fig.cap="A geometric distribution", echo=FALSE}
